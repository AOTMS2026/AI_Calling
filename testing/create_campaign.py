...
def run_campaign_automation_test(base_url, email, password, db_url, headless=False):
    """Automates logging in and constructing an outbound campaign."""
    print("\n--- 🤖 STARTING OUTBOUND CAMPAIGN AUTO-PROVISIONING ---")
    ...
    with sync_playwright() as p:
        ...
        # Step 2 (Skipped): We assume an agent already exists in the dropdown
...
def main():
    parser = argparse.ArgumentParser(description="Create Outbound Campaign automated test script")
    ...
    print("====================================================")
    print("   OUTBOUND CAMPAIGN AUTO-PROVISIONER    ")
    print("====================================================")
    ...
    success = run_campaign_automation_test(args.url, args.email, args.password, db_url, headless=args.headless)
    
    if args.cleanup:
        clean_test_entities_from_db(args.email, db_url)
        
    print("\n================ TEST SUMMARY ====================")
    print(f"Outbound Campaign Auto-Provision: {'✅ PASSED' if success else '❌ FAILED'}")
    print("====================================================")
